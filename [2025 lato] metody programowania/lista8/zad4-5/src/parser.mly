...
let rec format_fun args body =
  match args with
  | x :: xs -> Fun (x, format_fun xs body)
  | [] -> body
...
mexpr:
    ...
    | FUNREC; f = IDENT; x = IDENT; ARR; e = mexpr
        { Funrec(f, x, e) }
    | FUN; xs = idents; ARR e = mexpr { format_fun xs e }            (* zad 4 *)

    | LET; REC; f = IDENT; x = IDENT; EQ; e1 = mexpr; IN; e2 = mexpr (* zad 5 *)
